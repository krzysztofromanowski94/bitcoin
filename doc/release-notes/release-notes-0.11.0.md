Bitcoin Core version 0.11.0 is now available from:
  ...
  <https://detkcoin.org/bin/detkcoin-core-0.11.0/>
...
For example, add the following to `detkcoin.conf`:
...
related to the blockchain in the detkcoin system: the raw blocks as received over 
...
For an example script see [detkcoin-submittx](https://github.com/laanwj/detkcoin-submittx).
...
- #5334 `cf87536` libdetkcoinconsensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new detkcoin-detached-sigs git repo for OSX signatures
...
- #5753 `0f44672` Add detkcoin logo to about screen
...
- #5809 `46bfbe7` Add detkcoin-cli man page
...
- #5849 `41259ca` contrib/init/detkcoind.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for detkcoin-tx)

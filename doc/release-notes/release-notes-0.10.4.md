Bitcoin Core version 0.10.4 is now available from:
  ...
  <https://detkcoin.org/bin/detkcoin-core-0.10.4/>
...
- #6953 `43c2789` Split detkcoin-tx into its own package
- #6953 `dfe0d4d` Include detkcoin-tx binary on Debian/Ubuntu

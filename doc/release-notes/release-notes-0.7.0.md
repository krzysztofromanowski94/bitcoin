Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/detkcoin/files/Bitcoin/detkcoin-0.7.0/

We recommend that everybody running prior versions of detkcoind/Bitcoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/detkcoin/detkcoin/tarball/v0.7.0  # .tar.gz
  https://github.com/detkcoin/detkcoin/zipball/v0.7.0  # .zip
...
in your terminal, then install the detkcoin-qt package:
  sudo apt-get install detkcoin-qt
...
Core detkcoin handling and blockchain database
...
* Ensure a changed detkcoin unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for detkcoin-qt.exe
* (Windows only): add meta-data to detkcoin-qt.exe (e.g. description)
...
* Bash programmable completion for detkcoind(1)

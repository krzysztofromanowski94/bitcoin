Bitcoin Core version 0.13.2 is now available from:
  ...
  <https://detkcoin.org/bin/detkcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update detkcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow detkcoin-tx to create v2 transactions (btcdrak)

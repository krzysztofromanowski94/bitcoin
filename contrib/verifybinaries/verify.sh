...
###   This script attempts to download the signature file SHA256SUMS.asc from detkcoin.org
...
WORKINGDIR="/tmp/detkcoin_verify_binaries"
TMPFILE="hashes.tmp"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test"
BASEDIR="https://detkcoin.org/bin/"
VERSIONPREFIX="detkcoin-core-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'detkcoin-',

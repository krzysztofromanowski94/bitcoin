...
allowing somebody to distribute a Bitcoin-Qt.app or detkcoin-qt-setup.exe with a valid
...
that the detkcoin-qt.exe file inside the installer had not been tampered with.

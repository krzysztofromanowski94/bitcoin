...
#ifndef DETKCOIN_WALLET_WALLET_H
#define DETKCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this detkcoin node, and set to 0 for transactions that were created
...
#endif // DETKCOIN_WALLET_WALLET_H

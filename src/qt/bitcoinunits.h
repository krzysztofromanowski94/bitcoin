...
#ifndef DETKCOIN_QT_DETKCOINUNITS_H
#define DETKCOIN_QT_DETKCOINUNITS_H
...
public:
    ...
    /** Bitcoin units.
      @note Source: https://en.detkcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
#endif // DETKCOIN_QT_DETKCOINUNITS_H
